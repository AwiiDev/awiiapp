...
export default {
  ...
  mounted() {
    ...
    if (path.startsWith('/general-settings') || path.startsWith('/wallet-settings') 
    ...
    || (path.startsWith('/roles'))  || (path.startsWith('/permissions')))
    {
     ...
     || path.startsWith('/report/driver-duty-report') || path.startsWith('/drivers-levelup') || path.startsWith('/subscription') ||  path.startsWith('/incentives')
