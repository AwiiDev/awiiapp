...
<template>
    <Layout>
        ...
        <PageHeader :title="$t('driver_levelup')" :pageTitle="$t('driver_levelup')" />
        <BRow>
            <BCol lg="12">
                ...
                <BCard no-body id="">
                    ...
                    <BCardHeader class="border-0">
                        <BRow class="g-2">
                            ...
                            <div class="col-sm6" v-if="permissions.includes('add-drivers-levelup')">
                                <div class="mb-3">
                                <div class="border rounded">
                                    ...
                                    <div class="col">
                                        ...
                                        <input
                                            ...
                                            type="checkbox"
                                            v-model="show_driver_level_feature"
                                            class="form-check-input"
                                            id="show_driver_level_feature"
                                            @click.prevent="handleLevelUpUpdate"
                                        />
                                        </div>
                                    </div>
                                    </div>
                    ...
                    <BCard v-if="permissions.includes('change-reward-value') && show_driver_level_feature">
                    <BCardHeader class="border-0">
                        
                        <BRow class="g-2">
                            <div class="col-sm-6" v-if="permissions.includes('add-drivers-levelup') && show_driver_level_feature">
                                <div class="mb-3">
                            ...
                            <BCol md="auto" v-if="app_for!== 'demo'" class="ms-auto">
                                ...
                                <Link :href="`/drivers-levelup/create`" v-if="permissions.includes('add-drivers-levelup') && show_driver_level_feature">
