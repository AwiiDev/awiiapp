                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="#" @click.prevent="editData(result)" v-if="permissions.includes('edit-price')">
                                                        <i class="bx bxs-edit-alt align-center text-muted me-2"></i>{{$t('edit')}}
                                                    </a>
                                                    <a class="dropdown-item" href="#" @click.prevent="packagesData(result)" v-if="permissions.includes('add-package-price')">
                                                        <i class="bx bxs-edit-alt align-center text-muted me-2"></i>{{$t('packages')}}
                                                    </a>
                                                    <a class="dropdown-item" href="#" @click.prevent="deleteModal(result.id)" v-if="permissions.includes('delete-price')">
