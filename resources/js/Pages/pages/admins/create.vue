                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input type="text" name="email" class="form-control" :placeholder="$t('enter_email')" id="email"  v-model="form.email"
                      />
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input type="text"  name="pincode"  class="form-control" :placeholder="$t('enter_postal_code')" id="pincode"  v-model="form.pincode"
                      />
