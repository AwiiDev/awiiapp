                      ...
                      <div class="wallet"><div class="overlap">
                        <div class="card cards">
                          ...
                          <div class="input-group mt-3">
                              ...
                              <input disabled type="text" class="form-control" id="minimum_wallet_amount_for_transfer" placeholder="Enter Amount" aria-label="Username" aria-describedby="basic-addon1"
                              v-model="form.minimum_wallet_amount_for_transfer">
                          </div>
                          <div class="d-flex align-items-center justify-content-center gap-2 mt-3">
                          <div class="avatar-md p-1 py-2 h-auto bg border border-dashed rounded-3">
                              <div class="text-center"><h6 class="mb-0">${{form.minimum_wallet_amount_for_transfer}}</h6></div>
                          </div>
                          <div class="avatar-md p-1 py-2 h-auto bg border border-dashed rounded-3">
                              <div class="text-center"><h6 class="mb-0">${{form.minimum_wallet_amount_for_transfer*2}}</h6></div>
                          </div>
                          <div class="avatar-md p-1 py-2 h-auto bg border border-dashed rounded-3">
                              <div class="text-center"><h6 class="mb-0">${{form.minimum_wallet_amount_for_transfer*3}}</h6></div>
                          </div>
                        </div>
