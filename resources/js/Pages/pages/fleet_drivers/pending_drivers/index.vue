                            ...
                            <table class="table align-middle position-relative table-nowrap">
                                ...
                                <tbody v-if="results.length > 0">
                                    <tr v-for="(result, index) in results" :key="index">
                                        <td>
                                            <Link class="dropdown-item" :href="`/approved-drivers/view-profile/${result.id}`">{{ result.name }}</Link>
                                        </td> 
                                        ...
                                        <td>
                                            ...
                                            <BButton class="btn btn-soft-info btn-sm m-2" size="sm" type="button">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <Link class="dropdown-item" :href="`/fleet-drivers/document/${result.id}`" v-if="permissions.includes('approve-fleet-drivers')">
                                                    ...
                                                    <Link class="dropdown-item" :href="`/approved-drivers/view-profile/${result.id}`" v-if="permissions.includes('view-fleet-driver-profile')">
