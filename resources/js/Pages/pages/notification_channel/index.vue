...
export default {
  ...
  setup(props) {
    ...
    computed: {
    filtereduserResults() {
      return this.results.filter(result => result.role === 'user');
    },
    filtereddriverResults() {
      return this.results.filter(result => result.role === 'driver');
    }
  }
};
</script>
              ...
              <div class="tab-pane active" id="customers" role="tabpanel">
                <div class="table-responsive">
                  <table class="table align-middle position-relative table-nowrap">
                    ...
                    <tbody v-if="filtereduserResults.length > 0">
                      <tr v-for="(result, index) in filtereduserResults" :key="index">
                          <!-- <td>1</td> -->
                          <td>
                            <div>
              ...
              <div class="tab-pane " id="drivers" role="tabpanel">
                <div class="table-responsive">
                  <table class="table align-middle position-relative table-nowrap">
                    ...
                    <tbody v-if="filtereddriverResults.length > 0">
                      <tr v-for="(result, index) in filtereddriverResults" :key="index">
                          <!-- <td>1</td> -->
                          <td>
                            <div>
                              <h6 class="fw-bold">{{ result.topics }}</h6>
