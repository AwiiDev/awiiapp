              ...
              <!-- Name Field -->
                  ...
                  <div class="col-sm-6" v-if="showMaxWeightField">
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" :placeholder="'Enter ' + maxWeightLabel" id="capacity"
                  ...
                  <div class="col-sm-6" v-if="showSizeField">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" :placeholder="$t('enter_size')" id="size" v-model="form.size" />
...
const categories = ref([]); // Holds fetched category data
  ...
  mounted() {
    ...
    computed: {
    // Reactive computed property for filtered options
