...
<input type="number" class="form-control rounded-end flag-input" v-model="form.mobile" :placeholder="$t('enter_number')" @input="validateNumber">
...
<div class="text-center mt-2 amount">{{ vehicleType.ride_fare }}</div>
