...
onMounted(async () => {
  ...
  const currentLanguage = languages.value.find(lang => lang.code === i18n.global.locale);
  if (currentLanguage) {
    selectedLanguageCode.value = currentLanguage.code;
  }
  const defaultLanguage = languages.value.find(lang => lang.default === 1);

  const currentLocale = localStorage.getItem('locale') || defaultLanguage.code;
  await setInitialLanguage(currentLocale);
});

const setInitialLanguage = async (locale) => {
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown" v-if="permissions.includes('access-home')">
                                        <Link class="nav-link nav-menu" href="/dashboard" id="dropdownMenuButton" role="button"  aria-expanded="false"
                                            :class="{ 'active': ['/dashboard', '/promo-code','/set-prices', 
                                            ...
                                            '/push-notifications','/cancellation','/mail-template','/category','/banner-image','/complaint-title',
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" v-if="permissions.includes('dispatcher')">
                                    ...
                                    <li class="nav-item dropdown"  v-if="permissions.includes('access-user-nav-list')">
                                        <Link class="nav-link nav-menu" href="/users" id="dropdownMenuButton" role="button" aria-expanded="false"  
                                                ...
                                                '/delete-request-drivers', '/driver-needed-documents', '/report/driver-report','/drivers-levelup',
                                                '/pending-drivers', '/approved-drivers','/owner-needed-documents','/driver-bank-info','/report/fleet-report'
                                                ,'/fleet-drivers','/referral-settings','/incentives','/subscription','/drivers-rating','/manage-fleet',
                                                '/fleet-needed-documents','/owner-dashboard','/withdrawal-request-owners'].some(path => $page.url.startsWith(path)) }"
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                           ...
                                           <li class="dropdown-submenu mb-2"  v-if="permissions.includes('owner-management')" >
                                            ...
                                            <li class="dropdown-submenu mb-2"  v-if="permissions.includes('drivers-management')" >
                                                ...
                                                '/delete-request-drivers', '/driver-needed-documents', '/drivers-levelup',
                                    ...
                                    <li class="nav-item dropdown"  v-if="permissions.includes('access-settings-nav-list')">
                                        <Link class="nav-link nav-menu" href="/general-settings" id="dropdownMenuButton" aria-expanded="false" 
                                            ...
                                            '/wallet-settings','/payment-gateway','/sms-gateway',
